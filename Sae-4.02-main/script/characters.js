...
function generateRandomNumbers() {
    ...
    randomNumberPerson = Math.floor(Math.random() * NbrPerson);
    randomNumberQuestion = Math.floor(Math.random() * NbrQuestion);
}
...
export { PersonArrival, PersonDeparture, InitTask};