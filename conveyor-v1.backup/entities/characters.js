...
function PersonArrival() {
    ...
    entity.addEventListener("animationcomplete", function () {
        ...
        if (entity) {
            ...
            AskSound.play(); // Jouer le son après l'animation

            // Sauvegarde immédiate après l'apparition du personnage et la nouvelle question
            let currentScore = document.getElementById("ScoreBoard").getAttribute("value");
            let currentTimer = document.getElementById("timer").getAttribute("value");
...
function PersonDeparture() {
    ...
    let backgroundMusic = new Audio('./assets/sounds/Score_Up_sound.mp3');
...
export { PersonArrival, RemoveCharacters, InitTask, PersonDeparture, setQuestionNumber, setPersonNumber };